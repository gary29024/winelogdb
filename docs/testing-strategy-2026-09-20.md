# September 20 test policy and suite audit

Historical record of the previous all-PR policy and its measurements. For the current CI selection rules, see [Test strategy](testing-strategy.md).
