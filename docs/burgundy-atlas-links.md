...
A village link needs a village tier. When the wine has no recorded classification and names a mapped Premier Cru of its own appellation, or a Chablis Grand Cru climat, the link is withheld rather than presenting a Premier Cru or Grand Cru as a village wine. Only that appellation's crus count: La Romanée is a Gevrey-Chambertin Premier Cru and a Vosne-Romanée Grand Cru, and Les Perrières in Meursault says nothing about a Saint-Romain wine. A recorded `village` classification remains authoritative. The 36 Premier Cru plots Atlas has not mapped, such as Montée de Tonnerre, are not in the data and cannot trigger this check.
