...
import { classificationLabel,referenceSuggestionFields,type ReferenceSuggestion,type ReferenceSuggestionField } from '../src/lib/wine/referenceSuggestions';
...
app.put('/api/wines/:id/reference-suggestion',async c=>{
 ...
 if(field==='classification')value=suggestion.suggested==='Grand Cru'?'grand_cru':suggestion.suggested==='Premier Cru'?'premier_cru':suggestion.suggested==='Village'?'village':null;
