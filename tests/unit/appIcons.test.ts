...
const iconKeys:AppIconKey[]=['passport','journal','producers','insights','scan','single-wine','group-photo','batch-scan','pen','close','search','heart','heart-filled','lock','sparkle','chevron-right'];
