...
export function AppIcon({kind}:{kind:AppIconKey}){
  ...
  // A closed padlock: the reference block is read-only here, not read-only forever.
  if(kind==='lock')return <svg {...frame} className="app-icon"><rect x="4.6" y="10.4" width="14.8" height="9.8" rx="2.3"/><path d="M8.1 10.4V7.7a3.9 3.9 0 0 1 7.8 0v2.7"/><path d="M12 14v2.6"/></svg>;
