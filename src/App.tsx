...
export default function App(){return <BrowserRouter><Suspense fallback={<RouteFallback/>}><Routes><Route path="/login" element={<LoginPage/>}/><Route element={<RequireSession><Layout/></RequireSession>}><Route index element={<LibraryPage/>}/><Route path="producers" element={<ProducersPage/>}/><Route path="producers/:id" element={<ProducerDetailPage/>}/><Route path="passport" element={<PassportPage/>}/><Route path="insights" element={<InsightsPage/>}/><Route path="upload" element={<UploadPage/>}/><Route path="batch-scan" element={<BatchScanPage/>}/><Route path="wines/new" element={<section><h1>Add wine</h1><WineForm/></section>}/><Route path="wines/:id" element={<DetailPage/>}/><Route path="wines/:id/edit" element={<Edit/>}/></Route></Routes></Suspense></BrowserRouter>}
