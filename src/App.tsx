...
const AboutWineLogPage=lazy(()=>import('./features/legal/LegalPages').then(module=>({default:module.AboutWineLogPage})));
const PrivacyPolicyPage=lazy(()=>import('./features/legal/LegalPages').then(module=>({default:module.PrivacyPolicyPage})));
const TermsOfServicePage=lazy(()=>import('./features/legal/LegalPages').then(module=>({default:module.TermsOfServicePage})));
