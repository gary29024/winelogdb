...
export function BatchScanPage(){
  ...
  return <section className="batch-scan-page"><div className="hero compact"><p className="eyebrow">BATCH SCAN</p><h1>Scan several wines for less.</h1><p>Each section is one bottle. Add front, back, neck or other labels inside that bottle’s section. WineLog keeps each bottle’s labels together and identifies the wines in the background.</p></div>{error&&<p className="scan-error">{error}</p>}{notice&&<p className="producer-notice">{notice}</p>}
