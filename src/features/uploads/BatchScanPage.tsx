...
function recognitionInitial(r:RecognitionResult):Partial<WineInput>{return {producer:r.producer??'',wineName:r.wineName??'',vintage:r.vintage,country:r.country,region:r.region,appellation:r.appellation,recognizedRegion:r.recognizedRegion,recognizedAppellation:r.recognizedAppellation,grapes:r.grapes,grapeBlend:r.grapeBlend,wineStyle:r.style,alcoholPercentage:r.alcoholPercentage,sparklingDetails:r.sparklingDetails,tastingDate:r.tastingDate,locationName:r.locationName,latitude:r.latitude,longitude:r.longitude,tags:derivedTags({country:r.country,region:r.region,appellation:r.appellation,grapes:r.grapes,style:r.style}),recognitionConfidence:r.confidence,recognitionStatus:'review'}}
