...
export function GroupScanPage(){
  ...
  return <section className="group-scan-page">
    ...
    {unresolvedCount>0&&<p className="group-unresolved">WineLog saw {unresolvedCount} additional bottle{unresolvedCount===1?'':'s'} it could not identify confidently. Do not guess — use <strong>Add missed wine</strong> below if you can identify them yourself.</p>}
