...
export function DetailPage(){
 ...
 return <article className="detail wine-detail"><Link className="back-pill" to={back.to}>← {back.label}</Link>
  ...
  {technicalView&&<section className="detail-section"><LwinLinkEditor key={wine.id} wine={wine} disabled={Boolean(referenceBusy)} onLink={linkReference} onReject={rejectReference}/>{referenceError&&<p role="alert" className="detail-photo-error">{referenceError}</p>}</section>}
