...
export function JourneyStampIcon({kind}:{kind:MilestoneKey}){
  ...
  if(kind==='regions')return <svg {...common}><path d="M9 4.5 3.5 7v12.5L9 17l6 2.5 5.5-2.5V4.5L15 7 9 4.5Z"/><path d="M9 4.5V17m6-10v12.5"/></svg>;
  if(kind==='vintages')return <svg {...common}><rect x="4" y="5.5" width="16" height="14" rx="2"/><path d="M4 10h16M8.5 3.5v4m7-4v4"/><path d="M8.5 14h3"/></svg>;
