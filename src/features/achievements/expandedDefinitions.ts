...
export const expandedAchievementDefinitions:AchievementDefinition[]=[
  ...
  {id:'southern-rhone-ten-crus',title:'Southern Rhône Crus',subtitle:'Taste all ten current Southern Rhône cru AOCs, including Laudun.',category:'regional-exploration',icon:'rhone-crus',references:[{title:'Inter Rhône · Crus',url:rhone}],items:appellationItems('south-rhone',southernRhone)},
  {id:'bordeaux-1855-first-to-fifth',title:'1855 Bordeaux Classification Ladder',subtitle:'Complete every red-growth tier from First through Fifth Growth.',category:'iconic-estates',icon:'bordeaux-classification',references:[{title:'Conseil des Grands Crus Classés en 1855 · Classification',url:gcc1855}],items:producerItems('ladder1855',red1855)}
];
