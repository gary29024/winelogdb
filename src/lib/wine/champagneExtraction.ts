...
const FRENCH_TECH:Array<[RegExp,string]>=[
  [/\b(?:fermentation\s+)?malolactique non recherch(?:ée|é|ee|e)\b/gi,'malolactic fermentation not encouraged'],
  [/\b(?:fermentation\s+)?malolactique recherch(?:ée|é|ee|e)\b/gi,'malolactic fermentation encouraged'],
  [/\b(?:fermentation\s+)?malolactique bloqu(?:ée|é|ee|e)\b/gi,'malolactic fermentation blocked'],
  ...
  [/\bentonnage par gravit[ée]/gi,'barrel filling by gravity'],
  [/\bvins? non coll(?:ée|é|ee|e)s?\s*(?:\/|,|et)\s*non filtr(?:ée|é|ee|e)s?/gi,'unfined / unfiltered'],
  [/\bsans collage\b/gi,'unfined'],
  [/\bsans filtration\b/gi,'unfiltered'],
  [/\bnon coll(?:ée|é|ee|e)s?/gi,'unfined'],
  [/\bnon filtr(?:ée|é|ee|e)s?/gi,'unfiltered'],
  ...
  [/[ée]levage sur lies\b/gi,'lees ageing'],
  [/\bfermentation en f[uû]ts?\b/gi,'barrel fermentation'],
  [/[ée]levage en f[uû]ts? de ch[eê]ne\b/gi,'ageing in oak barrels'],
  [/[ée]levage en f[uû]ts?\b/gi,'barrel ageing'],
  [/\btirage courant d['’][ée]t[ée]/gi,'tirage during summer'],
  [/\bcourant d['’][ée]t[ée]/gi,'during summer'],
